...
export const PixDiscount = ({ originalPrice, pixPrice, discountPercent, currency = 'BRL', locale = 'pt-BR', size = 'md', className = '', }) => {
    ...
    return (<div className={`inline-flex flex-col gap-2 ${className}`} data-testid="pix-discount">
      {/* PIX Price */}
      <div className="flex items-baseline gap-1">
        <FormatPrice value={pixPrice} currency={currency} locale={locale} currencyClassName={currentSize.currency} integerClassName={currentSize.integer} decimalClassName={currentSize.decimal}/>
...
//# sourceMappingURL=PixDiscount.jsx.map