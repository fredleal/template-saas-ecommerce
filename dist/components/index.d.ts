...
export type { FooterProps, FooterSection, FooterLink, SocialLink, } from './organisms/Footer/Footer';
...
export type { FAQSectionProps, FAQItem, } from './organisms/FAQSection/FAQSection';
