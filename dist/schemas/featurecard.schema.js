export const featureCardSchema = {
    title: 'Feature Card',
    description: 'A card component to showcase features with icon, title, and description',
    type: 'object',
    properties: {
        icon: {
            type: 'string',
...
//# sourceMappingURL=featurecard.schema.js.map