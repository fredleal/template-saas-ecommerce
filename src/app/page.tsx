                ...
                <div className="space-y-4">
                  <div className="border-b pb-3">
                    ...
                    <Text size="sm" color="secondary">
                      &quot;Excelente produto! Superou minhas expectativas em
                      todos os aspectos.&quot;
                    </Text>
                  </div>
                  <div className="border-b pb-3">
                    ...
                    <Text size="sm" color="secondary">
                      &quot;Muito bom, entrega rápida e produto conforme
                      descrito.&quot;
                    </Text>
                  </div>
                  <div>
              ...
              >
                <div className="space-y-2">
                  ...
                  <Text size="sm" color="muted">
                    Nosso produto mais popular com milhares de avaliações
                    positivas.
                  </Text>
                  <div className="flex items-center gap-2">
                    <Icon
